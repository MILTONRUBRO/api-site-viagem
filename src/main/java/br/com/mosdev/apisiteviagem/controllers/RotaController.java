...
import br.com.mosdev.apisiteviagem.validator.AeroportoOrigemDestinoRotaValidator;
...
public class RotaController {
	...
	public void init(WebDataBinder dataBinder) {
		dataBinder.addValidators(new AeroportoOrigemDestinoRotaValidator(rotaRepository));
	}
